...
export default function Login({ status, canResetPassword, socialiteUrls }) {
                ...
                <form onSubmit={submit} className='login_form'>
                    <div className="form-container">
                        ...
                        <div className="login_form-socialite_container">
                            <SocialBtn className="discord" disabled={processing} href={socialiteUrls.discord}>
                            ...
                            <SocialBtn className="github" disabled={processing} href={socialiteUrls.github}>
